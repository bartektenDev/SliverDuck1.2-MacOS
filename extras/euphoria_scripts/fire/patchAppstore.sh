...
osascript -e 'display notification "Starting Appstore Patch..." with title "SliverDuck"'
...
# Kill iproxy
kill %1 > /dev/null 2>&1
osascript -e 'display notification "Appstore Patch Successful!" with title "SliverDuck"'
