...
root.iconphoto(False, tk.PhotoImage(file='ios8.png'))
...
def downExec():
    os.system("bash ./extras/iOS-OTA-Downgrader/restore8.sh")



root.title('iOS 8.4.1 Downgrade')
frame.pack()
...
maintext = Label(root, text="iOS 8.4.1 Downgrade",font=('Helveticabold', 24))
